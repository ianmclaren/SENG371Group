...
const ProfileHeader = () => {
  ...
  return (
    <HStack p={2} margin={3} border="solid" borderRadius={10} borderWidth={1}>
      <Box width="12%">
        <VStack p={1}>
          <img src="https://media.istockphoto.com/id/507995592/photo/pensive-man-looking-at-the-camera.jpg?s=170667a&w=0&k=20&c=gEjwbwM9D_0PERe2yR_b8dec_F1e6FrLf7yvWTdm4NY=" alt="profile" 
