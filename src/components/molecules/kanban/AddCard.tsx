...
export default function AddCard({
  ...
  addCard: (title: string, courseName: string, deadline: string) => void;
}) {
          ...
          <Form>
            <Flex gap={8}>
              <FormControl isRequired>
                <FormLabel textAlign="center">Task Title</FormLabel>
                <Input
                  type="text"
              ...
              <FormControl isRequired>
                <FormLabel textAlign="center">Course</FormLabel>
                <Popover
                ...
                >
                  <PopoverTrigger>
                    <Button
                      paddingInline={20}
                      bgColor={
                        sampleCourses.find((c) => c.id === course)?.color ||
                        "gray.400"
                      }
                      _hover={{
              ...
              <FormControl isRequired>
                <FormLabel textAlign="center">Deadline</FormLabel>
                <Input
                  type="datetime-local"
